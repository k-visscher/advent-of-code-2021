...
def calculate_position(pos_and_aim, dir_and_mov):
    if dir_and_mov.dir == "forward":
        return PosAndAim(pos_and_aim.x + dir_and_mov.mov, pos_and_aim.y + pos_and_aim.aim * dir_and_mov.mov, pos_and_aim.aim)
    elif dir_and_mov.dir == "up":
        return PosAndAim(pos_and_aim.x, pos_and_aim.y, pos_and_aim.aim - dir_and_mov.mov)
    else:
        return PosAndAim(pos_and_aim.x, pos_and_aim.y, pos_and_aim.aim + dir_and_mov.mov)
